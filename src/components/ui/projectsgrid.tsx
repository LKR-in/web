...
export const ProjectCard = ({
  ...
  const isNotStarted = project.title === "Developer Search Tool";
  const isBuilding = project.title === "Full-Stack Dashboard" || project.title === "Cloud Architecture Lab" || project.title === "LKR Organization";
