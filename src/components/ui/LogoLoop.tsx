...
const useResizeObserver = (callback: () => void, elements: React.MutableRefObject<any>[], dependencies: any[]) => {
  useEffect(() => {
...
const useImageLoader = (seqRef: React.MutableRefObject<any>, onLoad: () => void, dependencies: any[]) => {
  useEffect(() => {
